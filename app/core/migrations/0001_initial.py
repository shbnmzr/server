    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config_modified', models.CharField(blank=True, max_length=100, null=True)),
                ('sw_version', models.CharField(blank=True, max_length=100, null=True)),
                ('create_at', models.CharField(blank=True, max_length=100, null=True)),
